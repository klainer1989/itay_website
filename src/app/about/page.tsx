      ...
      <section className={styles.hero}>
        <div className={styles.container}>
          ...
          <p className={styles.subtitle}>
            איתי - דיאטנית קלינית מוסמכת ומומחית בתחום הבריאטריה
          </p>
        </div>
      </section>
        ...
        <div className={styles.container}>
          <div className={styles.content}>
            <div className={styles.textContent}>
              ...
              <h3>הגישה שלי</h3>
              <p>
                אני מאמינה שכל אדם יחיד במינו ומצריך גישה אישית ומותאמת. הליווי שלי מבוסס על:
              </p>
              <ul>
